...
public class TemperatureSensorBoard extends AbstractIOIOActivity implements OnCheckedChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_temperature_sensor_board);
